...
<div id="Page" class="main_cont">
    <!-- 版心内容区域-->
    <div page-name="applyData" class="pageName"></div>
    <div class="adShowTable">
        ...
        <div class="adShowTableShow">
            <div class="adShowTableHeader clearfix">
                <div class="adShowTablePlan floatL ML20"><b class="FS14">应用数据</b></div>
                <div class="floatR MR20">
                    <div class="miniBtn MT12"><a href="http://suchong.fst.weibo.com/app/app-reports/download?v=1439532908888&amp;_is_ajax=1&amp;customer_id=undefined&amp;per_page=15&amp;page=1" class="export_JS">
            ...
            <div class="adShowTableCell adShowTableCellWidth adShowTableCellHeight">
                <table>
                    <tbody><tr class="adShowTableTitle">
                        <th class="adShowTablePlan">应用ID</th>
                        <th class="adShowTableTime">应用名称</th>
                        ...
                        <th class="adShowTableStatus">转发量 </th>
                        <th class="adShowTableStatus">关注量 </th>
                        <th class="adShowTablePerform">赞量 </th>
                        <th class="adShowTableStatus">收藏量 </th>
                        ...
                        <th class="adShowTableStatus">激活成本</th>
                    </tr>
                    <tr>
