...
<div id="Page" class="main_cont">
    <!-- 版心内容区域-->
    <div page-name="tui" class="pageName"></div>
    <div class="appCon ideaBox_JS">
        <div class="appBar MB10">
            <div class="logoAndText centerT10 MB15"><img
                    src="http://js.t.sinajs.cn/weiboad/apps/app/images/app-name.png?v={{ getenv('STATIC_VERSION') }}" alt=""
                    class="logoAndTextImg logoAndTextImg_JS MB15"/>
                ...
                <div style="vertical-align:top;" class="myboxConL">
                    <div class="myboxConLCon myb2">
                        ...
                        <div class="adInputBox clearfix"><span class="floatL adInputTitle">卡片描述:</span>
                            ...
                            <p class="floatL adInputContent textBlack"><img
                                    src="http://js.t.sinajs.cn/weiboad/apps/app//images/icon_app_text.png" alt=""
                                    style="width:255px;height:127px;" class="ideaImages_JS"/></p>
                        </div>
                        <div class="adInputBox clearfix"><span class="floatL adInputTitle">卡片描述:</span>
                        ...
                        <div class="adInputBox clearfix"><span class="floatL adInputTitle">&nbsp;</span>
                            ...
                            <div class="floatL color000 adInputContent ideaSummeryE_JS">摄影 摄像</div>
                        </div>
                        ...
                        <div class="adShowApp">
                            <div class="adShowAppBox">
                                ...
                                <div class="adShowAppBody">
                                    <div class="MB10"><img
                                            src="http://js.t.sinajs.cn/weiboad/apps/app/images/icon_user_logo.jpeg?v={{ getenv('STATIC_VERSION') }}"
                                            alt="" width="40" height="40" class="icon_JS1"/>
                                  ...
                                  1分钟前</span><span class="adShowAppLocation">来自weibo.com</span></p>
                                    ...
                                    <div class="imgs_JS"><img
                                            src="http://js.t.sinajs.cn/weiboad/apps/app/images/icon_app_text.png?v={{ getenv('STATIC_VERSION') }}"
                                    ...
                                    <div class="adShowAppDownload MT10 FS14">
                                        ...
                                        <div data-rateit-value="2.5" data-rateit-ispreset="true"
                                             data-rateit-readonly="true" class="src2_JS myHide rateit"></div>
                                    </div>
                                </div>
                                <div class="adShowAppContact">
                                    <div>
                                        <p class="adShowAppContactImg"><span
                                                class="adShowAppContactForward FS14">0</span></p>

                                        <p class="adShowAppContactImg"><span
                                                class="adShowAppContactComment FS14">0</span></p>

                                        <p class="adShowAppContactLast"><span class="adShowAppContactLike FS14">0</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="mybox MT10">
            ...
            <div class="myboxCon width1066 planSetup_JS">
                <div style="vertical-align:top;" class="myboxConL">
                    <div class="myboxConLCon myb2">
                        <div style="overflow:visible" class="adInputBox clearfix"><span class="floatL adInputTitle"><b
                                    class="floatL"> </b>粉丝关系:</span>
                            ...
                            <div class="adplan-fans adplan-atom">
                                <div id="FansWrap" class="adplan-atc">
                                    <div id="fansPicker" style="position:relative;"
                                         class="input_pop user_input floatL ML10">
                                        <input id="fansInput" type="text" placeholder="请输入账户昵称"
                                               class="ui-text myHide adInputInput"/>

                                        <div id="fansDropLayer" style="z-index:999;left:0px;"
                                             class="fansDropLayer"></div>
                                    </div>
                                    <div class="blankBox"></div>
                                </div>
                                <!--fanspicker -->
                        ...
                        <div class="adInputBox clearfix"><span class="floatL adInputTitle"><b
                                    class="floatL"> </b>年龄:</span>

                            <div class="floatL textBlack adInputContent">
                                <input id="card-image" type="radio" name="age" checked="checked" value="-1"
                                       text-data="不限"/>
                                <label for="age">不限</label>
                                <input id="card-image" type="radio" name="age" value="customize" text-data="自定义"
                                       class="ML15"/>
                                <label for="age">自定义</label><span class="ageSelect_JS myHide">
                          <input id="AgeStart" data-age="min" maxlength="2" type="text" style="width:30px"
                                 class="adInputInput"/>-
                          <input id="AgeEnd" data-age="max" maxlength="2" type="text" style="width:30px"
                                 class="adInputInput"/><span class="errorField_JS ori"> </span><span id="ageErrBox"
                                                                                                     class="ori"></span></span>
                            </div>
                        </div>
                        <div class="adInputBox clearfix"><span class="floatL adInputTitle"><b
                                    class="floatL"> </b>性别:</span>

                            <div class="floatL textBlack adInputContent">
                                <input id="card-image" type="radio" name="gender" value="-1" text-data="不限"
                                       checked="checked"/>
                                <label for="gender">不限</label>
                                <input id="card-image" type="radio" name="gender" value="401" text-data="男"
                                       class="ML15"/>
                                <label for="gender">男</label>
                                <input id="mul-image" type="radio" name="gender" value="402" text-data="女"
                                       class="ML15"/>
                                <label for="mul-image">女</label>
                            </div>
                        </div>
                        <div class="adInputBox clearfix"><span class="floatL adInputTitle"><b
                                    class="floatL"> </b>地域:</span>

                            <div class="floatL textBlack adInputContent" id="RegionWrap">
                                <input id="card-image" type="radio" name="location" checked="checked" value="-1"
                                       text-data="不限"/>
                                <label for="location">不限</label>
                                <input id="card-image" type="radio" name="location" value="999" text-data="仅限中国大陆"
                                       class="ML15"/>
                                <label for="location">仅限中国大陆</label>
                                <input id="mul-image" type="radio" name="location" value="customize" text-data="自定义"
                                       class="ML15"/>
                                ...
                                <div class="adplan-atci adplan-diyRegions clearfix">
                                    <div class="fll addlist-outer">
                                        <div id="RegionInput" class="inputWrap fll">
                                            <input id="LocationInput" type="text" placeholder="可拼音或中文输入"
                                                   class="ui-text adInputInput"/><span class="icon icon-exp"> </span>
                                        </div>
                                        <!-- 已选中省列表-->
                        ...
                        <div class="adInputBox clearfix"><span class="floatL adInputTitle">系统版本:</span>
                            <select id="device" class="floatL adInputSelect textBlack">
                                <option value="130101" selected="selected" text-data="iOS2.0及以上">iOS2.0</option>
                                <option value="130102" text-data="iOS3.0及以上">iOS3.0</option>
                        ...
                        <div class="adInputBox clearfix"><span class="floatL adInputTitle">网络环境:</span>
                            ...
                            <div class="floatL textBlack adInputContent">
                                <input type="checkbox" name="netWork" value="1204" text-data="WiFi" checked="checked"/>
                    ...
                    <div class="myboxConCon myb2">
                        ...
                        <div class="adShowTableList">
                            <div class="adShowList clearfix"><span class="floatL adShowTableTitle">粉丝关系：</span>
                                ...
                                <p class="floatL color000 adShowContent planSetup_fans_JS">Loading...</p>
                            </div>
                            <div class="adShowList clearfix"><span class="floatL adShowTableTitle">年龄：</span>

                                <p class="floatL color000 adShowContent planSetup_age_JS">Loading...</p>
                            </div>
                            <div class="adShowList clearfix"><span class="floatL adShowTableTitle">性别：</span>

                                <p class="floatL color000 adShowContent planSetup_gender_JS">Loading...</p>
                            </div>
                            <div class="adShowList clearfix"><span class="floatL adShowTableTitle">地域：</span>

                                <p class="floatL color000 adShowContent planSetup_location_JS">Loading...</p>
                            </div>
                            <div class="adShowList clearfix"><span class="floatL adShowTableTitle">系统版本：</span>

                                <p class="floatL color000 adShowContent planSetup_device_JS">Loading...</p>
                            </div>
                            <div class="adShowList clearfix"><span class="floatL adShowTableTitle">网络环境：</span>

                                <p class="floatL color000 adShowContent planSetup_netWork_JS">Loading...</p>
                            </div>
                        </div>
        ...
        <div class="mybox MT10">
            ...
            <div class="myboxCon width1066 budgetBox_JS">
                <div style="vertical-align:top;">
                    <div class="myboxConLCon myb2">
                        <div class="adInputBox clearfix MB5"><span class="floatL adInputTitle">计划名称:</span>
                        ...
                        <div class="adInputBox clearfix"><span class="floatL adInputTitle">日限额:</span>
                          ...
                          <input type="text"
                                 class="adInputInput textBlack ML5 dayLimitedValue_JS"/><span>元/天</span></span>
                            </div>
                            <i title="指在投放周期内每天所要消耗的上限（单位：元）。默认为不限。" class="questionMark MT8 tips_JS"> </i>
                        </div>
                        <div class="adInputBox clearfix"><span class="floatL adInputTitle">设置出价:</span><span
                                class="floatL">CPM</span><i title="自动竞价，为增加移动应用安装而优化，我们会将广告展示给更可能安装应用的用户"
                                                            class="questionMark MT8 tips_JS"></i></div>
                        <div class="adInputBox clearfix"><span class="floatL adInputTitle">&nbsp;</span>
                        ...
                        <div class="adInputBox clearfix MB10"><span class="floatL adInputTitle"><b class="floatL"> </b>计划周期:</span>
                            ...
                            <div class="floatL textBlack">
                                ...
                                <label for="card-image">自定义</label><i
                                    title="指广告计划投放的时间段设定。或“立即开始、长期投放”；或自定义周期。默认为“立即开始、长期投放”。"
                                    class="questionMark tips_JS"></i>
                                <sapn class="planTimeInput_JS myHide">
                                    <input id="startDate" type="text" name="date-from" style="width:70px"
                                           class="adInputInput"/>
                                    ...
                                    <input id="endDate" type="text" name="date-to" style="width:70px"
                                           class="adInputInput"/>
        ...
        <div class="mybox MT10">
            ...
            <div class="adInputBox clearfix MB10 fish1_JS"><span style="width:100px" class="floatL adInputTitle"><b
                        class="floatL"> </b>监控地址:</span>
                <input placeholder="输入应用转化监控地址" class="floatL adInputInput textBlack talkingData_JS"/><i
                    title="请填写您在第三方生成的监控地址，目前支持TalkingData和AdMaster转换大师的监控地址。</br>应用家将根据该地址，获得您所推广的应用版本激活情况。" class="questionMark MT8 tips_JS"> </i>
            </div>
        </div>  
        <div class="btnLine MT10">
            <div class="btnConW226 centerT10">
                <div class="myBtn redBtn sBtn myShadow floatL submitPlan_JS">提交</div>
    ...
    <div class="mybox noIdeaBox_JS myHide">
        ...
        <div class="noAPP">
            ...
            <br/>暂无可用创意<br/><br/><a href="/app/creatives/create?customer_id={{ \UserInfo::getTargetUserId() }}&app_id={{ $app_id }}"  suda-uatrack="key=tblog_appllo_project&value=immediately_new_creative">立即创建创意</a>
        </div>
    </div>
    <!--这个是弹框-->
                    ...
                    <dl>
                        ...
                        <dd><span class="node leaf">
                          <label for="Location302">
                              <input id="Location302" data-parent="East" type="checkbox" data-value="北京" value="302"
                                     name="province"/>北京
                          </label></span><span class="node leaf">
                          <label for="Location303">
                              <input id="Location303" data-parent="East" type="checkbox" data-value="上海" value="303"
                                     name="province"/>上海
                          </label></span><span class="node leaf">
                          <label for="Location301">
                              <input id="Location301" data-parent="East" type="checkbox" data-value="广东" value="301"
                                     name="province"/>广东
                          </label></span><span class="node leaf">
                          <label for="Location311">
                              <input id="Location311" data-parent="East" type="checkbox" data-value="辽宁" value="311"
                                     name="province"/>辽宁
                          </label></span><span class="node leaf">
                          <label for="Location316">
                              <input id="Location316" data-parent="East" type="checkbox" data-value="天津" value="316"
                                     name="province"/>天津
                          </label></span><span class="node leaf">
                          <label for="Location312">
                              <input id="Location312" data-parent="East" type="checkbox" data-value="河北" value="312"
                                     name="province"/>河北
                          </label></span><span class="node leaf">
                          <label for="Location306">
                              <input id="Location306" data-parent="East" type="checkbox" data-value="山东" value="306"
                                     name="province"/>山东
                          </label></span><span class="node leaf">
                          <label for="Location305">
                              <input id="Location305" data-parent="East" type="checkbox" data-value="江苏" value="305"
                                     name="province"/>江苏
                          </label></span><span class="node leaf">
                          <label for="Location304">
                              <input id="Location304" data-parent="East" type="checkbox" data-value="浙江" value="304"
                                     name="province"/>浙江
                          </label></span><span class="node leaf">
                          <label for="Location307">
                              <input id="Location307" data-parent="East" type="checkbox" data-value="福建" value="307"
                                     name="province"/>福建
                          </label></span><span class="node leaf">
                          <label for="Location328">
                              <input id="Location328" data-parent="East" type="checkbox" data-value="海南" value="328"
                                     name="province"/>海南
                          </label></span></dd>
                    </dl>
                </td>
                    ...
                    <dl>
                        ...
                        <dd><span class="node leaf">
                          <label for="Location319">
                              <input id="Location319" data-parent="Middle" type="checkbox" data-value="黑龙江" value="319"
                                     name="province"/>黑龙江
                          </label></span><span class="node leaf">
                          <label for="Location321">
                              <input id="Location321" data-parent="Middle" type="checkbox" data-value="吉林" value="321"
                                     name="province"/>吉林
                          </label></span><span class="node leaf">
                          <label for="Location326">
                              <input id="Location326" data-parent="Middle" type="checkbox" data-value="内蒙古" value="326"
                                     name="province"/>内蒙古
                          </label></span><span class="node leaf">
                          <label for="Location323">
                              <input id="Location323" data-parent="Middle" type="checkbox" data-value="山西" value="323"
                                     name="province"/>山西
                          </label></span><span class="node leaf">
                          <label for="Location310">
                              <input id="Location310" data-parent="Middle" type="checkbox" data-value="河南" value="310"
                                     name="province"/>河南
                          </label></span><span class="node leaf">
                          <label for="Location317">
                              <input id="Location317" data-parent="Middle" type="checkbox" data-value="安徽" value="317"
                                     name="province"/>安徽
                          </label></span><span class="node leaf">
                          <label for="Location309">
                              <input id="Location309" data-parent="Middle" type="checkbox" data-value="湖北" value="309"
                                     name="province"/>湖北
                          </label></span><span class="node leaf">
                          <label for="Location313">
                              <input id="Location313" data-parent="Middle" type="checkbox" data-value="湖南" value="313"
                                     name="province"/>湖南
                          </label></span><span class="node leaf">
                          <label for="Location320">
                              <input id="Location320" data-parent="Middle" type="checkbox" data-value="江西" value="320"
                                     name="province"/>江西
                          </label></span><span class="node leaf">
                          <label for="Location315">
                              <input id="Location315" data-parent="Middle" type="checkbox" data-value="广西" value="315"
                                     name="province"/>广西
                          </label></span></dd>
                    </dl>
                </td>
                    ...
                    <dl>
                        ...
                        <dd><span class="node leaf">
                          <label for="Location314">
                              <input id="Location314" data-parent="West" type="checkbox" data-value="陕西" value="314"
                                     name="province"/>陕西
                          </label></span><span class="node leaf">
                          <label for="Location331">
                              <input id="Location331" data-parent="West" type="checkbox" data-value="宁夏" value="331"
                                     name="province"/>宁夏
                          </label></span><span class="node leaf">
                          <label for="Location330">
                              <input id="Location330" data-parent="West" type="checkbox" data-value="甘肃" value="330"
                                     name="province"/>甘肃
                          </label></span><span class="node leaf">
                          <label for="Location333">
                              <input id="Location333" data-parent="West" type="checkbox" data-value="青海" value="333"
                                     name="province"/>青海
                          </label></span><span class="node leaf">
                          <label for="Location318">
                              <input id="Location318" data-parent="West" type="checkbox" data-value="重庆" value="318"
                                     name="province"/>重庆
                          </label></span><span class="node leaf">
                          <label for="Location308">
                              <input id="Location308" data-parent="West" type="checkbox" data-value="四川" value="308"
                                     name="province"/>四川
                          </label></span><span class="node leaf">
                          <label for="Location324">
                              <input id="Location324" data-parent="West" type="checkbox" data-value="贵州" value="324"
                                     name="province"/>贵州
                          </label></span><span class="node leaf">
                          <label for="Location322">
                              <input id="Location322" data-parent="West" type="checkbox" data-value="云南" value="322"
                                     name="province"/>云南
                          </label></span><span class="node leaf">
                          <label for="Location329">
                              <input id="Location329" data-parent="West" type="checkbox" data-value="新疆" value="329"
                                     name="province"/>新疆
                          </label></span><span class="node leaf">
                          <label for="Location334">
                              <input id="Location334" data-parent="West" type="checkbox" data-value="西藏" value="334"
                                     name="province"/>西藏
                          </label></span></dd>
                    </dl>
                </td>
                    ...
                    <dl>
                        ...
                        <dd><span class="node leaf">
                          <label for="Location325">
                              <input id="Location325" data-parent="Special" type="checkbox" data-value="香港" value="325"
                                     name="province"/>香港
                          </label></span><span class="node leaf">
                          <label for="Location332">
                              <input id="Location332" data-parent="Special" type="checkbox" data-value="澳门" value="332"
                                     name="province"/>澳门
                          </label></span><span class="node leaf">
                          <label for="Location327">
                              <input id="Location327" data-parent="Special" type="checkbox" data-value="台湾" value="327"
                                     name="province"/>台湾
                          </label></span><span class="node leaf">
                          <label for="Location335">
                              <input id="Location335" data-parent="Special" type="checkbox" data-value="美国" value="335"
                                     name="province"/>美国
                          </label></span><span class="node leaf">
                          <label for="Location336">
                              <input id="Location336" data-parent="Special" type="checkbox" data-value="加拿大" value="336"
                                     name="province"/>加拿大
                          </label></span><span class="node leaf">
                          <label for="Location337">
                              <input id="Location337" data-parent="Special" type="checkbox" data-value="澳大利亚"
                                     value="337" name="province"/>澳大利亚
                          </label></span><span class="node leaf">
                          <label for="Location338">
                              <input id="Location338" data-parent="Special" type="checkbox" data-value="英国" value="338"
                                     name="province"/>英国
                          </label></span><span class="node leaf">
                          <label for="Location339">
                              <input id="Location339" data-parent="Special" type="checkbox" data-value="马来西亚"
                                     value="339" name="province"/>马来西亚
                          </label></span><span class="node leaf">
                          <label for="Location340">
                              <input id="Location340" data-parent="Special" type="checkbox" data-value="日本" value="340"
                                     name="province"/>日本
                          </label></span><span class="node leaf">
                          <label for="Location341">
                              <input id="Location341" data-parent="Special" type="checkbox" data-value="新加坡" value="341"
                                     name="province"/>新加坡
                          </label></span><span class="node leaf">
                          <label for="Location342">
                              <input id="Location342" data-parent="Special" type="checkbox" data-value="海外其他"
                                     value="342" name="province"/>海外其他
                          </label></span></dd>
                    </dl>
                </td>
            </tr>
                    ...
                    <dl>
                        ...
                        <dd><span class="node leaf">
                          <label for="Location300">
                              <input id="Location300" data-parent="Other" type="checkbox" data-value="其他地区" value="300"
                                     name="province"/>其他地区
                          </label></span></dd>
                    </dl>
                </td>
